...
DROP TABLE IF EXISTS project_aasigned_ussers CASCADE;

CREATE TABLE project_aasigned_ussers (
...
ALTER TABLE ONLY project_aasigned_ussers
    ADD CONSTRAINT project_aasigned_ussers_pkey PRIMARY KEY (project_id, user_id);
...
ALTER TABLE ONLY projects
    ADD CONSTRAINT project_manager_id_fk FOREIGN KEY (project_manager_id) REFERENCES users(id);