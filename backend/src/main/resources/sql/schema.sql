...
DROP TABLE IF EXISTS project_assigned_users CASCADE;
...
ALTER TABLE ONLY project_assigned_users
    ADD CONSTRAINT project_assigned_users_pkey PRIMARY KEY (project_id, user_id);
