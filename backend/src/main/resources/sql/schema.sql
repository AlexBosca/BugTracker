...
ALTER TABLE confirmation_tokens ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME confirmation_tokens_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
DROP TABLE IF EXISTS team_access_requests CASCADE;
...
ALTER TABLE team_access_requests ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME team_access_requests_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
DROP TABLE IF EXISTS teams_on_project CASCADE;

CREATE TABLE teams_on_project (
    project_id bigint NOT NULL,
    team_id bigint NOT NULL
);

DROP TABLE IF EXISTS users_in_team CASCADE;
...
ALTER TABLE ONLY confirmation_tokens
    ADD CONSTRAINT confirmation_tokens_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY team_access_requests
    ADD CONSTRAINT team_access_requests_pkey PRIMARY KEY (id);


ALTER TABLE ONLY teams_on_project
    ADD CONSTRAINT teams_on_project_pkey PRIMARY KEY (project_id, team_id);
...
ALTER TABLE ONLY users_in_team
    ADD CONSTRAINT users_in_team_pkey PRIMARY KEY (team_id, user_id);
