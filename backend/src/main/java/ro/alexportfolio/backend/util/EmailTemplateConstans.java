...
public enum EmailTemplateConstans {
    ...
    PASSWORD_RESET_EMAIL_TEMPLATE_NAME("password-reset-email"),
    ...
    PASSWORD_RESET_EMAIL_TEMPLATE_PATH( EMAIL_HTML_TEMPLATE_ROOT.getValue() + PASSWORD_RESET_EMAIL_TEMPLATE_NAME.getValue()),
